...
export class MaintenanceController {
  ...
  @ApiResponse({
    status: 200,
    description: 'The maintenance records have been successfully retrieved.',
  })
  async findAll(
    @Req() request: Request,
  ...
  @ApiResponse({
    status: 200,
    description: 'The maintenance record has been successfully retrieved.',
  })
  ...
  async update(
    @Req() request: Request,
    @Param('id') id: string,
    @Body() updateMaintenanceDto: MaintenanceDto,
  ) {
