import { Controller, Query, Param, Get, Req, Post, Put } from '@nestjs/common';
...
export class MemberController extends BaseOrganizerController {
  ...
  @Put('memberships/approval/:membershipRequest')
  async approval(@Param('membershipRequest') membershipRequest) {
    return this.memberService.approvalMembershipRequest(membershipRequest);
  }
}
